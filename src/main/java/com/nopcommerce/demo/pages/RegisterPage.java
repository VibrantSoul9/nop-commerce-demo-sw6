...
public class RegisterPage extends Utility {
    ...
    public void enterFirstName(String lastName){
        ...
        CustomListeners.node.log(Status.PASS, "Enter Firstname : '" + firstNameField + "' to firstName field");
        Reporter.log("Enter Firstname : '"+ firstNameField + "' to firstName field" + "<br>");
        log.info("Enter Firstname : '" + firstNameField + "' to firstName field");
    }
