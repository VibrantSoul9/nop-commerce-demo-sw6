...
public class LoginPage extends Utility {
    ...
    public void enterEmailID(String email){
        ...
        log.info("Enter EmailId '" + email + "'to email field :"+ emailField.getText());
    }
    public void enterPassword(String password) {
        sendTextToElement(passwordField, password);
        CustomListeners.node.log(Status.PASS, "Enter Password '" + password + "'to password field :" + passwordField.getText());
    ...
    public String getErrorMessage(){
        ...
        Reporter.log("Getting error message :"+ errorMessage.getText());
