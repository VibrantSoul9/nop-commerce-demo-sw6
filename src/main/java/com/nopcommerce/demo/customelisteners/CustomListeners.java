...
public class CustomListeners implements ITestListener {
    ...
    public void onTestFailure(ITestResult iTestResult) {
        //This step will take screenshot and store in to test-output/html folder
        String screenshotPath = takeScreenShot(iTestResult.getName());
        //This lines are required for Extent report
        ...
        Reporter.log("<br>");
        Reporter.log("<br>");
        Reporter.log("<a target = \"_blank\" href=" + screenshotPath + "><img scr=" + screenshotPath +
                " height=200 width=200></imp></a>");
    ...
    public void onStart(ITestContext iTestContext) {
        reports = ExtentReportManager.getReports(); // imported  nopcommerce.demo.extentreports.ExtentReportManager after writing extentreportmanager class
        test = reports.createTest(iTestContext.getAllTestMethods()[0].getInstance().getClass().getSimpleName())
                .assignAuthor("Jigna").assignCategory("Smoke");
    }
    @Override
